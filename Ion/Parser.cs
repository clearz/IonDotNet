...
namespace Lang
{
    ...
    public unsafe partial class Ion
    {
        ...
        Expr* parse_expr_compound(Typespec* type) {
            ...
            return expr_compound(type, buf, buf.count);
        }
        ...
        Stmt* parse_stmt_switch() {
            ...
            expect_token(TOKEN_RBRACE);
            return stmt_switch(expr, buf, buf.count);
        }
        ...
        Decl* parse_decl_enum() {
            ...
            expect_token(TOKEN_RBRACE);
            return decl_enum(name, buf._begin, buf.count);
        }
        ...
        Decl* parse_decl_aggregate(DeclKind kind) {
            ...
            expect_token(TOKEN_RBRACE);
            return decl_aggregate(kind, name, buf, buf.count);
        }
        ...
        Decl* parse_decl_func() {
            ...
            StmtList block = parse_stmt_block();
            return decl_func(name, buf, buf.count, ret_type, block);
        }
