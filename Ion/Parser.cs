...
namespace Lang
{
    ...
    public unsafe partial class Ion
    {
		...
		Typespec* parse_type_func() {
            ...
            return typespec_func((Typespec**)buf->_begin, buf->count, ret); // ast_dup(buf, buf->count * PTR_SIZE)
        }
        ...
        Expr* parse_expr_compound(Typespec* type) {
            ...
            return expr_compound(type, buf, (size_t)buf.count);
        }
        ...
        Stmt* parse_stmt_if() {
            ...
            StmtList else_block = default(StmtList);
            ElseIf* elseifs = null;
            ...
            return stmt_if(cond, then_block, buf, (size_t)buf.count,
                else_block);
        }
        ...
        Stmt* parse_stmt_switch() {
            ...
            expect_token(TOKEN_RBRACE);
            return stmt_switch(expr, buf, (size_t)buf.count);
        }
        ...
        Decl* parse_decl_enum() {
            ...
            expect_token(TOKEN_RBRACE);
            return decl_enum(name, (EnumItem*) buf._begin, (size_t)buf.count);
        }
        ...
        Decl* parse_decl_aggregate(DeclKind kind) {
            ...
            expect_token(TOKEN_RBRACE);
            return decl_aggregate(kind, name, buf, (size_t)buf.count);
        }
        ...
        Decl* parse_decl_func() {
            ...
            StmtList block = parse_stmt_block();
            return decl_func(name, buf, (size_t)buf.count, ret_type, block);
        }
