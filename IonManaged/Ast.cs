namespace IonLangManaged
{
    ...
    public unsafe partial class Ion {
        ...
        Note new_note(SrcPos pos, string name, NoteArg[] args, int num_args) {
            return new Note { pos = pos, name = name, args = args, num_args = num_args };
        }

        Notes new_notes(Note[] notes, int num_notes) {
            return new Notes {notes = notes, num_notes = num_notes};
        }
        ...
        Note? get_stmt_note(Stmt stmt, string name) {
